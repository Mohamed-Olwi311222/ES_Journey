...
# 11 "ECU_Layer/keypad/../../MCAL_Layer/GPIO/../../std_types.h" 2
...
# 54 "ECU_Layer/keypad/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef union
{
    struct
    {
...
# 120 "ECU_Layer/keypad/../../MCAL_Layer/GPIO/hal_gpio.h"
...
Std_ReturnType keypad_initialize(const keypad_t *keypad_obj)
{
    ...
    uint8 l_row_counter = 0x00, l_col_counter = 0x00;
    ...
    {
        for (; l_row_counter < 4; l_row_counter++)
        {
        ...
        {
            for (; l_col_counter < 4; l_col_counter++)
            {
...
{
    Std_ReturnType ret = (Std_ReturnType)0x00u;
    uint8 l_row_counter = 0x00, l_col_counter = 0x00, l_counter = 0x00;
