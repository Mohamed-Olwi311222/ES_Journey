...
# 11 "ECU_Layer/Char_LCD/../../MCAL_Layer/GPIO/../../std_types.h"
...
# 11 "ECU_Layer/Char_LCD/../../MCAL_Layer/GPIO/../../std_types.h" 2
...
# 54 "ECU_Layer/Char_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef union
{
    struct
    {
...
# 31 "ECU_Layer/Char_LCD/ecu_char_lcd.c"
...
# 47 "ECU_Layer/Char_LCD/ecu_char_lcd.c"
...
Std_ReturnType lcd_4bit_initialize(const char_lcd_4bit_t *lcd)
{
 ...
 else
 {
        ...
        if ((Std_ReturnType)0x00u == ret)
        {
            ...
            if ((Std_ReturnType)0x00u == ret)
            {
                for (lcd_data_counter = 0x00; lcd_data_counter < 4; lcd_data_counter++)
                {
                ...
                if ((Std_ReturnType)0x00u == ret)
                {
                    ...
                    _delay((unsigned long)((20)*((8 *1000UL *1000UL)/4000.0)));
                    ret = lcd_4bit_send_command(lcd, 0x38);
                    _delay((unsigned long)((5)*((8 *1000UL *1000UL)/4000.0)));
                    ret = lcd_4bit_send_command(lcd, 0x38);
                    _delay((unsigned long)((150)*((8 *1000UL *1000UL)/4000000.0)));
                    ret = lcd_4bit_send_command(lcd, 0x38);
...
Std_ReturnType lcd_8bit_initialize(const char_lcd_8bit_t *lcd)
{
 ...
 else
 {
        ...
        if ((Std_ReturnType)0x00u == ret)
        {
            ...
            if ((Std_ReturnType)0x00u == ret)
            {
                for (lcd_data_counter = 0x00; lcd_data_counter < 8; lcd_data_counter++)
                {
                    ret = gpio_pin_initialize(&(lcd->lcd_data[lcd_data_counter]));
                    if ((Std_ReturnType)0x01u == ret)
                    {
...
static Std_ReturnType lcd_send_4bits(const char_lcd_4bit_t *lcd, uint8 data_command)
{
    ...
    else
    {
        ...
        {
            ret = gpio_pin_write_logic(&(lcd->lcd_data[counter]), (data_command >> counter) & (uint8)1);
            if ((Std_ReturnType)0x01u == ret)
            {
                break;
            }
...
static Std_ReturnType lcd_4bit_send_enable_signal(const char_lcd_4bit_t *lcd)
{
    ...
    else
    {
        ...
        _delay((unsigned long)((5)*((8 *1000UL *1000UL)/4000000.0)));
        if ((Std_ReturnType)0x00u == ret)
        {
...
Std_ReturnType convert_uint8_to_string(uint8 value, uint8 *str)
{
 ...
 {
  memset(str, '\0', 4);
  if (snprintf((char *)str, 4, "%u", value) < 0)
  {
   ret = (Std_ReturnType)0x01u;
  }
    }
