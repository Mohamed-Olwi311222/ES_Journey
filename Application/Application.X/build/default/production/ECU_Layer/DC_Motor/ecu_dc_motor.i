...
# 54 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef union
{
    struct
    {
...
# 120 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
...
Std_ReturnType dc_motor_initialize(const dc_motor_t *dc_motor)
{
    ...
    else
    {
        ...
        gpio_pin_initialize(&(dc_motor->dc_motor_pins[0x01U]));
    }
    return (ret);
}
...
Std_ReturnType dc_motor_move_forward(const dc_motor_t *dc_motor)
{
    ...
    else
    {
        ...
        gpio_pin_write_logic(&(dc_motor->dc_motor_pins[0x01U]), GPIO_LOW);
    }
    return (ret);
}
...
Std_ReturnType dc_motor_move_backward(const dc_motor_t *dc_motor)
{
    ...
    else
    {
        ...
        gpio_pin_write_logic(&(dc_motor->dc_motor_pins[0x01U]), GPIO_HIGH);
    }
    return (ret);
}
